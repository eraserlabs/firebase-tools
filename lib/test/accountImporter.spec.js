...
describe("accountImporter", () => {
    ...
    describe("transArrayToUser", () => {
        it("should reject when passwordHash is invalid base64", () => {
            (0, chai_1.expect)(transArrayToUser(["123", undefined, undefined, "false"])).to.have.property("error");
        });
        it("should not reject when passwordHash is valid base64", () => {
            (0, chai_1.expect)(transArrayToUser(["123", undefined, undefined, "Jlf7onfLbzqPNFP/1pqhx6fQF/w="])).to.not.have.property("error");
        });
    });
    describe("validateOptions", () => {
        it("should reject when unsupported hash algorithm provided", () => {
            (0, chai_1.expect)(() => validateOptions({ hashAlgo: "MD2" })).to.throw();
        });
        it("should reject when missing parameters", () => {
            (0, chai_1.expect)(() => validateOptions({ hashAlgo: "HMAC_SHA1" })).to.throw();
        });
    });
    describe("validateUserJson", () => {
        it("should reject when unknown fields in user json", () => {
            (0, chai_1.expect)(validateUserJson({
                uid: "123",
                email: "test@test.org",
...
//# sourceMappingURL=accountImporter.spec.js.map