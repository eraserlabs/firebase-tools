...
const database = require("../../../../deploy/functions/services/database");
...
describe("ensureDatabaseTriggerRegion", () => {
    ...
    it("should error if the trigger location is set incorrectly", () => {
        ...
        (0, chai_1.expect)(() => database.ensureDatabaseTriggerRegion(ep)).to.throw("A database trigger location must match the function region.");
    });
});
