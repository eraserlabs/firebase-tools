...
const gcfNSV2 = require("../../../../gcp/cloudfunctionsv2");
const gcfNS = require("../../../../gcp/cloudfunctions");
const eventarcNS = require("../../../../gcp/eventarc");
const pollerNS = require("../../../../operation-poller");
const pubsubNS = require("../../../../gcp/pubsub");
const schedulerNS = require("../../../../gcp/cloudscheduler");
const runNS = require("../../../../gcp/run");
const cloudtasksNS = require("../../../../gcp/cloudtasks");
const backend = require("../../../../deploy/functions/backend");
const scraper = require("../../../../deploy/functions/release/sourceTokenScraper");
const v2events = require("../../../../functions/events/v2");
const v1events = require("../../../../functions/events/v1");
const servicesNS = require("../../../../deploy/functions/services");
const identityPlatformNS = require("../../../../gcp/identityPlatform");
const auth_1 = require("../../../../deploy/functions/services/auth");
describe("Fabricator", () => {
    let gcf;
    let gcfv2;
    let eventarc;
    ...
    beforeEach(() => {
        ...
        identityPlatform.getBlockingFunctionsConfig.rejects(new Error("unexpected identityPlatform.getBlockingFunctionsConfig"));
        identityPlatform.setBlockingFunctionsConfig.rejects(new Error("unexpected identityPlatform.setBlockingFunctionsConfig"));
    });
    afterEach(() => {
    ...
    function endpoint(trigger = { httpsTrigger: {} }, base = {}) {
        return Object.assign(Object.assign({ platform: "gcfv1", id: "id", region: "us-central1", entryPoint: "entrypoint", runtime: "nodejs16", availableMemoryMb: 256, cpu: backend.memoryToGen1Cpu(256), codebase: "default" }, JSON.parse(JSON.stringify(base))), trigger);
    }
    describe("createV1Function", () => {
        it("throws on create function failure", async () => {
            gcf.createFunction.rejects(new Error("Server failure"));
            await (0, chai_1.expect)(fab.createV1Function(endpoint(), new scraper.SourceTokenScraper())).to.be.rejectedWith(reporter.DeploymentError, "create");
        ...
        it("throws on set invoker failure", async () => {
            ...
            await (0, chai_1.expect)(fab.createV1Function(endpoint(), new scraper.SourceTokenScraper())).to.be.rejectedWith(reporter.DeploymentError, "set invoker");
        });
        describe("httpsTrigger", () => {
            it("enforces SECURE_ALWAYS HTTPS policies", async () => {
                ...
                (0, chai_1.expect)(gcf.createFunction).to.have.been.calledWithMatch({
                    httpsTrigger: {
            ...
            it("sets public invoker by default", async () => {
                ...
                const ep = endpoint();
                await fab.createV1Function(ep, new scraper.SourceTokenScraper());
                (0, chai_1.expect)(gcf.setInvokerCreate).to.have.been.calledWith(ep.project, backend.functionName(ep), [
                    "public",
                ]);
            });
            ...
            it("doesn't set private invoker on create", async () => {
                ...
                await fab.createV1Function(ep, new scraper.SourceTokenScraper());
                (0, chai_1.expect)(gcf.setInvokerCreate).to.not.have.been.called;
            });
        });
    ...
    describe("updateV1Function", () => {
        it("throws on update function failure", async () => {
            ...
            await (0, chai_1.expect)(fab.updateV1Function(endpoint(), new scraper.SourceTokenScraper())).to.be.rejectedWith(reporter.DeploymentError, "update");
        ...
        it("throws on set invoker failure", async () => {
            ...
            await (0, chai_1.expect)(fab.updateV1Function(ep, new scraper.SourceTokenScraper())).to.be.rejectedWith(reporter.DeploymentError, "set invoker");
        });
        it("sets explicit invoker", async () => {
            ...
            (0, chai_1.expect)(gcf.setInvokerUpdate).to.have.been.calledWith(ep0.project, backend.functionName(ep0), [
                "custom@",
            ]);
            (0, chai_1.expect)(gcf.setInvokerUpdate).to.have.been.calledWith(ep1.project, backend.functionName(ep1), [
                "custom@",
            ]);
            (0, chai_1.expect)(gcf.setInvokerUpdate).to.have.been.calledWith(ep2.project, backend.functionName(ep2), [
                "public",
            ]);
        });
        it("does not set invoker by default", async () => {
            ...
            (0, chai_1.expect)(gcf.setInvokerUpdate).to.not.have.been.called;
        });
        it("doesn't set invoker on non-http functions", async () => {
            gcf.updateFunction.resolves({ name: "op", type: "update", done: false });
            poller.pollOperation.resolves();
    ...
    describe("deleteV1Function", () => {
        it("throws on delete function failure", async () => {
            ...
            const ep = endpoint();
            await (0, chai_1.expect)(fab.deleteV1Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "delete");
    ...
    describe("createV2Function", () => {
        it("handles topics that already exist", async () => {
            ...
            (0, chai_1.expect)(pubsub.createTopic).to.have.been.called;
            (0, chai_1.expect)(gcfv2.createFunction).to.have.been.called;
        });
        it("handles failures to create a topic", async () => {
            ...
            await (0, chai_1.expect)(fab.createV2Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "create topic");
        });
        it("handles already existing eventarc channels", async () => {
            ...
            await fab.createV2Function(ep);
            (0, chai_1.expect)(eventarc.getChannel).to.have.been.called;
            (0, chai_1.expect)(eventarc.createChannel).to.not.have.been.called;
            (0, chai_1.expect)(gcfv2.createFunction).to.have.been.called;
        });
        it("handles already existing eventarc channels (createChannel return 409)", async () => {
            ...
            eventarc.createChannel.callsFake(({ name }) => {
                (0, chai_1.expect)(name).to.equal("channel");
                const err = new Error("Already exists");
                err.status = 409;
                return Promise.reject(err);
            });
            ...
            await fab.createV2Function(ep);
            (0, chai_1.expect)(eventarc.createChannel).to.have.been.called;
            (0, chai_1.expect)(gcfv2.createFunction).to.have.been.called;
        });
        it("creates channels if necessary", async () => {
            ...
            eventarc.getChannel.resolves(undefined);
            eventarc.createChannel.callsFake(({ name }) => {
                (0, chai_1.expect)(name).to.equal(channelName);
            ...
            await fab.createV2Function(ep);
            (0, chai_1.expect)(eventarc.createChannel).to.have.been.calledOnceWith({ name: channelName });
            (0, chai_1.expect)(poller.pollOperation).to.have.been.called;
        });
        it("wraps errors thrown while creating channels", async () => {
            ...
            await (0, chai_1.expect)(fab.createV2Function(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "upsert eventarc channel");
        });
        it("throws on create function failure", async () => {
            gcfv2.createFunction.rejects(new Error("Server failure"));
            const ep = endpoint({ httpsTrigger: {} }, { platform: "gcfv2" });
            await (0, chai_1.expect)(fab.createV2Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "create");
            gcfv2.createFunction.resolves({ name: "op", done: false });
            poller.pollOperation.rejects(new Error("Fail whale"));
            await (0, chai_1.expect)(fab.createV2Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "create");
        });
        it("throws on set invoker failure", async () => {
            ...
            const ep = endpoint({ httpsTrigger: {} }, { platform: "gcfv2" });
            await (0, chai_1.expect)(fab.createV2Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "set invoker");
        });
        describe("httpsTrigger", () => {
            it("sets invoker to public by default", async () => {
                ...
                const ep = endpoint({ httpsTrigger: {} }, { platform: "gcfv2" });
                await fab.createV2Function(ep);
                (0, chai_1.expect)(run.setInvokerCreate).to.have.been.calledWith(ep.project, "service", ["public"]);
            });
            it("sets explicit invoker", async () => {
                gcfv2.createFunction.resolves({ name: "op", done: false });
                poller.pollOperation.resolves({ serviceConfig: { service: "service" } });
                ...
                await fab.createV2Function(ep);
                (0, chai_1.expect)(run.setInvokerCreate).to.have.been.calledWith(ep.project, "service", ["custom@"]);
            });
            it("doesn't set private invoker on create", async () => {
                gcfv2.createFunction.resolves({ name: "op", done: false });
                poller.pollOperation.resolves({ serviceConfig: { service: "service" } });
                ...
                await fab.createV2Function(ep);
                (0, chai_1.expect)(run.setInvokerCreate).to.not.have.been.called;
            });
        });
        describe("callableTrigger", () => {
            it("always sets invoker to public", async () => {
        ...
        describe("blockingTrigger", () => {
            it("always sets invoker to public", async () => {
                ...
                poller.pollOperation.resolves({ serviceConfig: { service: "service" } });
                run.setInvokerCreate.resolves();
                const ep = endpoint({ blockingTrigger: { eventType: v1events.BEFORE_CREATE_EVENT } }, { platform: "gcfv2" });
                await fab.createV2Function(ep);
                (0, chai_1.expect)(run.setInvokerCreate).to.have.been.calledWith(ep.project, "service", ["public"]);
            });
        });
        it("doesn't set invoker on non-http functions", async () => {
            ...
            poller.pollOperation.resolves({ serviceConfig: { service: "service" } });
            run.setInvokerCreate.resolves();
            const ep = endpoint({ eventTrigger: { eventType: "event", eventFilters: {}, retry: false } }, { platform: "gcfv2" });
            await fab.createV2Function(ep);
            (0, chai_1.expect)(run.setInvokerCreate).to.not.have.been.called;
        });
    });
    describe("updateV2Function", () => {
        it("throws on update function failure", async () => {
            ...
            const ep = endpoint({ httpsTrigger: {} }, { platform: "gcfv2" });
            await (0, chai_1.expect)(fab.updateV2Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "update");
        ...
        it("throws on set invoker failure", async () => {
            ...
            const ep = endpoint({ httpsTrigger: { invoker: ["private"] } }, { platform: "gcfv2" });
            await (0, chai_1.expect)(fab.updateV2Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "set invoker");
        });
        it("sets explicit invoker on httpsTrigger", async () => {
            ...
            (0, chai_1.expect)(run.setInvokerUpdate).to.have.been.calledWith(ep.project, "service", ["custom@"]);
        });
        ...
        it("sets explicit invoker on blockingTrigger", async () => {
            ...
            await fab.updateV2Function(ep);
            (0, chai_1.expect)(run.setInvokerUpdate).to.have.been.calledWith(ep.project, "service", ["public"]);
        });
        it("does not set invoker by default", async () => {
            gcfv2.updateFunction.resolves({ name: "op", done: false });
            poller.pollOperation.resolves({ serviceConfig: { service: "service" } });
            ...
            const ep = endpoint({ httpsTrigger: {} }, { platform: "gcfv2" });
            await fab.updateV2Function(ep);
            (0, chai_1.expect)(run.setInvokerUpdate).to.not.have.been.called;
        });
        it("doesn't set invoker on non-http functions", async () => {
            gcfv2.updateFunction.resolves({ name: "op", done: false });
            poller.pollOperation.resolves({ serviceConfig: { service: "service" } });
    ...
    describe("deleteV2Function", () => {
        it("throws on delete function failure", async () => {
            ...
            const ep = endpoint({ httpsTrigger: {} }, { platform: "gcfv2" });
            await (0, chai_1.expect)(fab.deleteV2Function(ep)).to.be.rejectedWith(reporter.DeploymentError, "delete");
    ...
    describe("upsertScheduleV1", () => {
        ...
        it("upserts schedules", async () => {
            ...
            (0, chai_1.expect)(scheduler.createOrReplaceJob).to.have.been.called;
        });
        it("wraps errors", async () => {
            scheduler.createOrReplaceJob.rejects(new Error("Fail"));
            await (0, chai_1.expect)(fab.upsertScheduleV1(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "upsert schedule");
        });
    });
    describe("upsertScheduleV2", () => {
        const ep = Object.assign(Object.assign({}, endpoint({
            scheduleTrigger: {
                schedule: "every 5 minutes",
            },
        })), { platform: "gcfv2" });
        ...
        it("wraps errors", async () => {
            scheduler.createOrReplaceJob.rejects(new Error("Fail"));
            await (0, chai_1.expect)(fab.upsertScheduleV2(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "upsert schedule");
        });
    });
    describe("deleteScheduleV1", () => {
        ...
        it("deletes schedules and topics", async () => {
            ...
            (0, chai_1.expect)(scheduler.deleteJob).to.have.been.called;
            (0, chai_1.expect)(pubsub.deleteTopic).to.have.been.called;
        });
        it("wraps errors", async () => {
            scheduler.deleteJob.rejects(new Error("Fail"));
            await (0, chai_1.expect)(fab.deleteScheduleV1(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "delete schedule");
            scheduler.deleteJob.resolves();
            pubsub.deleteTopic.rejects(new Error("Fail"));
            await (0, chai_1.expect)(fab.deleteScheduleV1(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "delete topic");
        });
    });
    describe("deleteScheduleV2", () => {
        ...
        it("wraps errors", async () => {
            scheduler.deleteJob.rejects(new Error("Fail"));
            await (0, chai_1.expect)(fab.deleteScheduleV2(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "delete schedule");
        });
    });
    describe("upsertTaskQueue", () => {
        it("upserts task queues", async () => {
            ...
            (0, chai_1.expect)(tasks.upsertQueue).to.have.been.called;
            (0, chai_1.expect)(tasks.setEnqueuer).to.not.have.been.called;
        });
        it("sets enqueuer", async () => {
            ...
            await fab.upsertTaskQueue(ep);
            (0, chai_1.expect)(tasks.upsertQueue).to.have.been.called;
            (0, chai_1.expect)(tasks.setEnqueuer).to.have.been.calledWithMatch(tasks.queueNameForEndpoint(ep), [
                "public",
            ]);
        });
        it("wraps errors", async () => {
            ...
            await (0, chai_1.expect)(fab.upsertTaskQueue(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "upsert task queue");
            tasks.upsertQueue.resolves();
            tasks.setEnqueuer.rejects(new Error("nope"));
            await (0, chai_1.expect)(fab.upsertTaskQueue(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "set invoker");
        });
    });
    describe("disableTaskQueue", () => {
        it("disables task queues", async () => {
            ...
            (0, chai_1.expect)(tasks.updateQueue).to.have.been.calledWith({
        ...
        it("wraps errors", async () => {
            ...
            await (0, chai_1.expect)(fab.disableTaskQueue(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "disable task queue");
        });
    });
    describe("registerBlockingTrigger", () => {
        ...
        it("registers auth blocking trigger", async () => {
            ...
            (0, chai_1.expect)(identityPlatform.getBlockingFunctionsConfig).to.have.been.called;
            (0, chai_1.expect)(identityPlatform.setBlockingFunctionsConfig).to.have.been.called;
        });
        it("wraps errors", async () => {
            services.serviceForEndpoint.returns(authBlockingService);
            identityPlatform.getBlockingFunctionsConfig.rejects(new Error("Fail"));
            await (0, chai_1.expect)(fab.registerBlockingTrigger(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "register blocking trigger");
        });
    });
    describe("unregisterBlockingTrigger", () => {
        ...
        it("wraps errors", async () => {
            services.serviceForEndpoint.returns(authBlockingService);
            identityPlatform.getBlockingFunctionsConfig.rejects(new Error("Fail"));
            await (0, chai_1.expect)(fab.unregisterBlockingTrigger(ep)).to.eventually.be.rejectedWith(reporter.DeploymentError, "unregister blocking trigger");
        });
    });
    describe("setTrigger", () => {
        ...
        it("sets schedule triggers", async () => {
            ...
            await fab.setTrigger(ep);
            (0, chai_1.expect)(upsertScheduleV1).to.have.been.called;
            upsertScheduleV1.restore();
            ep.platform = "gcfv2";
            const upsertScheduleV2 = sinon.stub(fab, "upsertScheduleV2");
            upsertScheduleV2.resolves();
            await fab.setTrigger(ep);
            (0, chai_1.expect)(upsertScheduleV2).to.have.been.called;
        });
        it("sets task queue triggers", async () => {
            ...
            await fab.setTrigger(ep);
            (0, chai_1.expect)(upsertTaskQueue).to.have.been.called;
        });
    });
    describe("deleteTrigger", () => {
        ...
        it("deletes schedule triggers", async () => {
            ...
            await fab.deleteTrigger(ep);
            (0, chai_1.expect)(deleteScheduleV1).to.have.been.called;
            deleteScheduleV1.restore();
            ep.platform = "gcfv2";
            const deleteScheduleV2 = sinon.stub(fab, "deleteScheduleV2");
            deleteScheduleV2.resolves();
            await fab.deleteTrigger(ep);
            (0, chai_1.expect)(deleteScheduleV2).to.have.been.called;
        });
        it("deletes task queue triggers", async () => {
            ...
            await fab.deleteTrigger(ep);
            (0, chai_1.expect)(disableTaskQueue).to.have.been.called;
        });
    });
    describe("createEndpoint", () => {
        it("creates v1 functions", async () => {
            ...
            (0, chai_1.expect)(createV1Function).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledAfter(createV1Function);
        });
        it("creates v2 functions", async () => {
            ...
            await fab.createEndpoint(ep, new scraper.SourceTokenScraper());
            (0, chai_1.expect)(createV2Function).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledAfter(createV2Function);
        });
        it("aborts for failures midway", async () => {
            ...
            await (0, chai_1.expect)(fab.createEndpoint(ep, new scraper.SourceTokenScraper())).to.be.rejectedWith(reporter.DeploymentError, "set invoker");
            (0, chai_1.expect)(createV1Function).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.not.called;
        });
    });
    describe("updateEndpoint", () => {
        it("updates v1 functions", async () => {
            ...
            (0, chai_1.expect)(updateV1Function).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledAfter(updateV1Function);
        });
        it("updates v2 functions", async () => {
            ...
            await fab.updateEndpoint({ endpoint: ep }, new scraper.SourceTokenScraper());
            (0, chai_1.expect)(updateV2Function).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.calledAfter(updateV2Function);
        });
        it("aborts for failures midway", async () => {
            const ep = endpoint();
            const setTrigger = sinon.stub(fab, "setTrigger");
            ...
            await (0, chai_1.expect)(fab.updateEndpoint({ endpoint: ep }, new scraper.SourceTokenScraper())).to.be.rejectedWith(reporter.DeploymentError, "set invoker");
            (0, chai_1.expect)(updateV1Function).is.calledOnce;
            (0, chai_1.expect)(setTrigger).is.not.called;
        });
        it("can delete and create", async () => {
            const target = endpoint({ scheduleTrigger: { schedule: "every 5 minutes" } }, { platform: "gcfv2" });
            const before = endpoint({ scheduleTrigger: { schedule: "every 5 minutes" } }, { platform: "gcfv1" });
            const update = {
                endpoint: target,
            ...
            (0, chai_1.expect)(deleteTrigger).to.have.been.called;
            (0, chai_1.expect)(deleteV1Function).to.have.been.calledImmediatelyAfter(deleteTrigger);
            (0, chai_1.expect)(createV2Function).to.have.been.calledImmediatelyAfter(deleteV1Function);
            (0, chai_1.expect)(setTrigger).to.have.been.calledImmediatelyAfter(createV2Function);
        });
    });
    describe("deleteEndpoint", () => {
        ...
        it("deletes v2 functions", async () => {
            ...
            await fab.deleteEndpoint(ep);
            (0, chai_1.expect)(deleteTrigger).to.have.been.called;
            (0, chai_1.expect)(deleteV2Function).to.have.been.calledImmediatelyAfter(deleteTrigger);
        });
        it("does not delete functions with triggers outstanding", async () => {
            ...
            deleteV2Function.resolves();
            await (0, chai_1.expect)(fab.deleteEndpoint(ep)).to.eventually.be.rejected;
            (0, chai_1.expect)(deleteV2Function).to.not.have.been.called;
        });
    });
    describe("applyRegionalUpdates", () => {
        it("shares source token scrapers across upserts", async () => {
            ...
            let sourceTokenScraper;
            let callCount = 0;
            const fakeUpsert = (unused, s) => {
                callCount++;
                if (!sourceTokenScraper) {
                    (0, chai_1.expect)(callCount).to.equal(1);
                    sourceTokenScraper = s;
                }
                (0, chai_1.expect)(s).to.equal(sourceTokenScraper);
                return Promise.resolve();
            };
        ...
        it("handles errors and wraps them in results", async () => {
            ...
            (0, chai_1.expect)(results[0].error).to.be.instanceOf(reporter.DeploymentError);
            (0, chai_1.expect)((_a = results[0].error) === null || _a === void 0 ? void 0 : _a.message).to.match(/create function/);
        });
    });
    describe("getLogSuccessMessage", () => {
        it("should return appropriate messaging for create case", () => {
            ...
            (0, chai_1.expect)(message).to.contain(`functions[potato(us-central1)]`);
            (0, chai_1.expect)(message).to.contain(`Successful create operation`);
        });
        it("should return appropriate messaging for skip case", () => {
            ...
            (0, chai_1.expect)(message).to.contain(`functions[tomato(us-central1)]`);
            (0, chai_1.expect)(message).to.contain(`Skipped (No changes detected)`);
        });
    });
    describe("getSkippedDeployingNopOpMessage", () => {
        it("should return appropriate messaging", () => {
            ...
            (0, chai_1.expect)(message).to.contain(`functions:`);
            (0, chai_1.expect)(message).to.contain(`You can re-deploy skipped functions with:`);
            (0, chai_1.expect)(message).to.contain(`firebase deploy --only functions:function1,function2`);
            (0, chai_1.expect)(message).to.contain(`FUNCTIONS_DEPLOY_UNCHANGED=true firebase deploy`);
        });
    });
    it("does not delete if there are upsert errors", async () => {
        ...
        (0, chai_1.expect)(result === null || result === void 0 ? void 0 : result.error).to.be.instanceOf(reporter.AbortedDeploymentError);
        (0, chai_1.expect)(result === null || result === void 0 ? void 0 : result.durationMs).to.equal(0);
    });
    it("applies all kinds of changes", async () => {
        ...
        const update = { endpoint: updateEP };
        const changes = {
            endpointsToCreate: [createEP],
        ...
        const results = await fab.applyChangeset(changes);
        (0, chai_1.expect)(createEndpoint).to.have.been.calledWithMatch(createEP);
        (0, chai_1.expect)(updateEndpoint).to.have.been.calledWithMatch(update);
        (0, chai_1.expect)(deleteEndpoint).to.have.been.calledWith(deleteEP);
        (0, chai_1.expect)(results[0].error).to.be.undefined;
        (0, chai_1.expect)(results[1].error).to.be.undefined;
        (0, chai_1.expect)(results[2].error).to.be.undefined;
    });
    describe("applyPlan", () => {
        it("fans out to regions", async () => {
            ...
            (0, chai_1.expect)(ep1Result === null || ep1Result === void 0 ? void 0 : ep1Result.error).to.be.instanceOf(reporter.DeploymentError);
            (0, chai_1.expect)((_a = ep1Result === null || ep1Result === void 0 ? void 0 : ep1Result.error) === null || _a === void 0 ? void 0 : _a.message).to.match(/create function/);
            const ep2Result = summary.results.find((r) => r.endpoint.region === ep2.region);
            (0, chai_1.expect)(ep2Result === null || ep2Result === void 0 ? void 0 : ep2Result.error).to.be.instanceOf(reporter.DeploymentError);
            (0, chai_1.expect)((_b = ep2Result === null || ep2Result === void 0 ? void 0 : ep2Result.error) === null || _b === void 0 ? void 0 : _b.message).to.match(/delete function/);
        });
    });
});
//# sourceMappingURL=fabricator.spec.js.map