...
const runtime = require("../../../../../deploy/functions/runtimes/node/parseRuntimeAndValidateSDK");
describe("getRuntimeChoice", () => {
    ...
    context("when the runtime is set in firebase.json", () => {
        ...
        it("should throw error if unsupported node version set", () => {
            (0, chai_1.expect)(() => runtime.getRuntimeChoice("path/to/source", "nodejs11")).to.throw(error_1.FirebaseError, runtime.UNSUPPORTED_NODE_VERSION_FIREBASE_JSON_MSG);
        });
    });
    context("when the runtime is not set in firebase.json", () => {
        ...
        it("should throw error if unsupported node version set", () => {
            ...
            (0, chai_1.expect)(() => runtime.getRuntimeChoice("path/to/source", "")).to.throw(error_1.FirebaseError, runtime.UNSUPPORTED_NODE_VERSION_PACKAGE_JSON_MSG);
        });
    });
});
