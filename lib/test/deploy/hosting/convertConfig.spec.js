...
const convertConfig_1 = require("../../../deploy/hosting/convertConfig");
...
function endpoint(opts) {
    var _a;
    const ret = Object.assign({ id: FUNCTION_ID, project: PROJECT_ID, entryPoint: FUNCTION_ID, region: REGION, runtime: "nodejs16", platform: "gcfv1" }, opts);
    if (!("httpsTrigger" in ret ||
        "eventTrigger" in ret ||
    ...
    if ((opts === null || opts === void 0 ? void 0 : opts.platform) === "gcfv2") {
        ret.runServiceId = (_a = opts === null || opts === void 0 ? void 0 : opts.id) !== null && _a !== void 0 ? _a : SERVICE_ID;
    }
    return ret;
}
describe("convertConfig", () => {
    ...
    for (const { name, input, existingBackend, want, functionsPayload } of tests) {
        it(name, async () => {
            ...
            const deploy = {
                config: Object.assign({ site: "site" }, input),
                version: "version",
            };
            const config = await (0, convertConfig_1.convertConfig)(context, functionsPayload || {}, deploy);
            (0, chai_1.expect)(config).to.deep.equal(want);
        });
    }
    describe("rewrites errors", () => {
        it("should throw when rewrite points to function in the wrong region", async () => {
            await (0, chai_1.expect)((0, convertConfig_1.convertConfig)({ projectId: "1" }, {
                functions: {
                    default: {
                        wantBackend: backend.of({
                            id: FUNCTION_ID,
                ...
                version: "14",
            })).to.eventually.be.rejectedWith(error_1.FirebaseError);
        });
    ...
    describe("with permissions issues", () => {
        ...
        it("should not throw when resolving backends", async () => {
            existingBackendStub.rejects(new error_1.FirebaseError("Some permissions 403 error (that should be caught)", { status: 403 }));
            await (0, chai_1.expect)((0, convertConfig_1.convertConfig)({ projectId: "1" }, {}, {
                config: {
                    site: "foo",
...
//# sourceMappingURL=convertConfig.spec.js.map