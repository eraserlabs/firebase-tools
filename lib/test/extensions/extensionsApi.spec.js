...
const TEST_INSTANCES_RESPONSE_NEXT_PAGE_TOKEN = (0, utils_1.cloneDeep)(TEST_INSTANCES_RESPONSE);
...
describe("extensions", () => {
    describe("listInstances", () => {
        ...
        it("should return a list of installed extensions instances", async () => {
            ...
            (0, chai_1.expect)(instances).to.deep.equal(TEST_INSTANCES_RESPONSE.instances);
        ...
        it("should query for more installed extensions if the response has a next_page_token", async () => {
            ...
            (0, chai_1.expect)(instances).to.deep.equal(expected);
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
        it("should throw FirebaseError if any call returns an error", async () => {
            ...
            nock(api.extensionsOrigin)
                ...
                .reply(503);
            await (0, chai_1.expect)(extensionsApi.listInstances(PROJECT_ID)).to.be.rejectedWith(error_1.FirebaseError);
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
    describe("createInstance", () => {
        ...
        it("should throw a FirebaseError if create returns an error response", async () => {
            nock(api.extensionsOrigin)
                ...
                .query({ validateOnly: "false" })
                .reply(500);
            await (0, chai_1.expect)(extensionsApi.createInstance({
                projectId: PROJECT_ID,
                instanceId: INSTANCE_ID,
                extensionSource: {
                    state: "ACTIVE",
                ...
                params: {},
            })).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 500, Unknown Error");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
    describe("configureInstance", () => {
        ...
        it("should throw a FirebaseError if update returns an error response", async () => {
            nock(api.extensionsOrigin)
                ...
                .reply(500);
            await (0, chai_1.expect)(extensionsApi.configureInstance({
                projectId: PROJECT_ID,
                instanceId: INSTANCE_ID,
                params: { MY_PARAM: "value" },
                canEmitEvents: false,
            })).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 500");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
    describe("deleteInstance", () => {
        ...
        it("should throw a FirebaseError if delete returns an error response", async () => {
            nock(api.extensionsOrigin)
                .delete(`/${VERSION}/projects/${PROJECT_ID}/instances/${INSTANCE_ID}`)
                .reply(404);
            await (0, chai_1.expect)(extensionsApi.deleteInstance(PROJECT_ID, INSTANCE_ID)).to.be.rejectedWith(error_1.FirebaseError);
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
    describe("updateInstance", () => {
        ...
        it("should include config.params in updateMask is params are changed", async () => {
            nock(api.extensionsOrigin)
                .patch(`/${VERSION}/projects/${PROJECT_ID}/instances/${INSTANCE_ID}`)
                .query({
                updateMask: "config.source.name,config.params,config.allowed_event_types,config.eventarc_channel",
                validateOnly: "false",
            })
                .reply(200, { name: "operations/abc123" });
            nock(api.extensionsOrigin).get(`/${VERSION}/operations/abc123`).reply(200, { done: true });
        ...
        it("should include config.system_params in updateMask if system_params are changed", async () => {
            nock(api.extensionsOrigin)
                .patch(`/${VERSION}/projects/${PROJECT_ID}/instances/${INSTANCE_ID}`)
                .query({
                updateMask: "config.source.name,config.system_params,config.allowed_event_types,config.eventarc_channel",
                validateOnly: "false",
            })
                .reply(200, { name: "operations/abc123" });
            nock(api.extensionsOrigin).get(`/${VERSION}/operations/abc123`).reply(200, { done: true });
        ...
        it("should throw a FirebaseError if update returns an error response", async () => {
            nock(api.extensionsOrigin)
                ...
                .reply(500);
            await (0, chai_1.expect)(extensionsApi.updateInstance({
                projectId: PROJECT_ID,
                instanceId: INSTANCE_ID,
                extensionSource: testSource,
                params: {
    ...
    describe("getInstance", () => {
        ...
        it("should throw a FirebaseError if the endpoint returns an error response", async () => {
            nock(api.extensionsOrigin)
                .get(`/${VERSION}/projects/${PROJECT_ID}/instances/${INSTANCE_ID}`)
                .reply(404);
            await (0, chai_1.expect)(extensionsApi.getInstance(PROJECT_ID, INSTANCE_ID)).to.be.rejectedWith(error_1.FirebaseError);
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
    describe("getSource", () => {
        ...
        it("should make a GET call to the correct endpoint", async () => {
            ...
            (0, chai_1.expect)(nock.isDone()).to.be.true;
            (0, chai_1.expect)(source.spec.resources).to.have.lengthOf(1);
            (0, chai_1.expect)(source.spec.resources[0]).to.have.property("properties");
        });
        it("should throw a FirebaseError if the endpoint returns an error response", async () => {
            nock(api.extensionsOrigin).get(`/${VERSION}/${SOURCE_NAME}`).reply(404);
            await (0, chai_1.expect)(extensionsApi.getSource(SOURCE_NAME)).to.be.rejectedWith(error_1.FirebaseError);
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
    describe("createSource", () => {
        ...
        it("should throw a FirebaseError if create returns an error response", async () => {
            ...
            await (0, chai_1.expect)(extensionsApi.createSource(PROJECT_ID, PACKAGE_URI, "./")).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 500, Unknown Error");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
        it("stop polling and throw if the operation call throws an unexpected error", async () => {
            ...
            await (0, chai_1.expect)(extensionsApi.createSource(PROJECT_ID, PACKAGE_URI, "./")).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 502, Unknown Error");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
});
describe("publishExtensionVersion", () => {
    ...
    it("should make a POST call to the correct endpoint, and then poll on the returned operation", async () => {
        ...
        const res = await extensionsApi.publishExtensionVersion(TEST_EXT_VERSION_3.ref, "www.google.com/test-extension.zip");
        (0, chai_1.expect)(res).to.deep.equal(TEST_EXT_VERSION_3);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw a FirebaseError if publishExtensionVersion returns an error response", async () => {
        nock(api.extensionsOrigin)
            ...
            .reply(500);
        await (0, chai_1.expect)(extensionsApi.publishExtensionVersion(`${PUBLISHER_ID}/${EXTENSION_ID}@${EXTENSION_VERSION}`, "www.google.com/test-extension.zip", "/")).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 500, Unknown Error");
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("stop polling and throw if the operation call throws an unexpected error", async () => {
        nock(api.extensionsOrigin)
            ...
            .reply(200, { name: "operations/abc123" });
        nock(api.extensionsOrigin).get(`/${VERSION}/operations/abc123`).reply(502, {});
        await (0, chai_1.expect)(extensionsApi.publishExtensionVersion(`${PUBLISHER_ID}/${EXTENSION_ID}@${EXTENSION_VERSION}`, "www.google.com/test-extension.zip", "/")).to.be.rejectedWith(error_1.FirebaseError, "HTTP Error: 502, Unknown Error");
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(extensionsApi.publishExtensionVersion(`${PUBLISHER_ID}/${EXTENSION_ID}`, "www.google.com/test-extension.zip", "/")).to.be.rejectedWith(error_1.FirebaseError, "ExtensionVersion ref");
    });
});
describe("deleteExtension", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsOrigin)
            .delete(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}`)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.deleteExtension(`${PUBLISHER_ID}/${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(extensionsApi.deleteExtension(`${PUBLISHER_ID}/${EXTENSION_ID}@0.1.0`)).to.be.rejectedWith(error_1.FirebaseError, "must not contain a version");
    });
});
describe("unpublishExtension", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsOrigin)
            .post(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}:unpublish`)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.unpublishExtension(`${PUBLISHER_ID}/${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(extensionsApi.unpublishExtension(`${PUBLISHER_ID}/${EXTENSION_ID}@0.1.0`)).to.be.rejectedWith(error_1.FirebaseError, "must not contain a version");
    });
});
describe("getExtension", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsOrigin)
            .get(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}`)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.getExtension(`${PUBLISHER_ID}/${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(extensionsApi.getExtension(`${PUBLISHER_ID}`)).to.be.rejectedWith(error_1.FirebaseError, "Unable to parse");
    });
});
describe("getExtensionVersion", () => {
    ...
    it("should make a GET call to the correct endpoint", async () => {
        nock(api.extensionsOrigin)
            .get(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}/versions/${EXTENSION_VERSION}`)
            .reply(200, TEST_EXTENSION_1);
        const got = await extensionsApi.getExtensionVersion(`${PUBLISHER_ID}/${EXTENSION_ID}@${EXTENSION_VERSION}`);
        (0, chai_1.expect)(got).to.deep.equal(TEST_EXTENSION_1);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsOrigin)
            .get(`/${VERSION}/publishers/${PUBLISHER_ID}/extensions/${EXTENSION_ID}/versions/${EXTENSION_VERSION}`)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.getExtensionVersion(`${PUBLISHER_ID}/${EXTENSION_ID}@${EXTENSION_VERSION}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(extensionsApi.getExtensionVersion(`${PUBLISHER_ID}//${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError, "Unable to parse");
    });
});
describe("listExtensions", () => {
    ...
    it("should return a list of published extensions", async () => {
        ...
        (0, chai_1.expect)(extensions).to.deep.equal(PUBLISHED_EXTENSIONS.extensions);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should return a list of all extensions", async () => {
        ...
        const extensions = await extensionsApi.listExtensions(PUBLISHER_ID);
        (0, chai_1.expect)(extensions).to.deep.equal(ALL_EXTENSIONS.extensions);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should query for more extensions if the response has a next_page_token", async () => {
        ...
        (0, chai_1.expect)(extensions).to.deep.equal(expected);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw FirebaseError if any call returns an error", async () => {
        nock(api.extensionsOrigin)
        ...
        await (0, chai_1.expect)(extensionsApi.listExtensions(PUBLISHER_ID)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("listExtensionVersions", () => {
    ...
    it("should return a list of published extension versions", async () => {
        ...
        (0, chai_1.expect)(extensions).to.deep.equal(PUBLISHED_EXT_VERSIONS.extensionVersions);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should send filter query param", async () => {
        nock(api.extensionsOrigin)
            ...
            .reply(200, PUBLISHED_EXT_VERSIONS);
        const extensions = await extensionsApi.listExtensionVersions(`${PUBLISHER_ID}/${EXTENSION_ID}`, "id<1.0.0");
        (0, chai_1.expect)(extensions).to.deep.equal(PUBLISHED_EXT_VERSIONS.extensionVersions);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should return a list of all extension versions", async () => {
        ...
        const extensions = await extensionsApi.listExtensionVersions(`${PUBLISHER_ID}/${EXTENSION_ID}`);
        (0, chai_1.expect)(extensions).to.deep.equal(ALL_EXT_VERSIONS.extensionVersions);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should query for more extension versions if the response has a next_page_token", async () => {
        ...
        const extensions = await extensionsApi.listExtensionVersions(`${PUBLISHER_ID}/${EXTENSION_ID}`);
        const expected = PUBLISHED_VERSIONS_WITH_TOKEN.extensionVersions.concat(NEXT_PAGE_VERSIONS.extensionVersions);
        (0, chai_1.expect)(extensions).to.deep.equal(expected);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw FirebaseError if any call returns an error", async () => {
        ...
        nock(api.extensionsOrigin)
            ...
            .reply(500);
        await (0, chai_1.expect)(extensionsApi.listExtensionVersions(`${PUBLISHER_ID}/${EXTENSION_ID}`)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw an error for an invalid ref", async () => {
        await (0, chai_1.expect)(extensionsApi.listExtensionVersions("")).to.be.rejectedWith(error_1.FirebaseError, "Unable to parse");
    });
});
describe("getPublisherProfile", () => {
    ...
    it("should make a GET call to the correct endpoint", async () => {
        ...
        (0, chai_1.expect)(res).to.deep.equal(PUBLISHER_PROFILE);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsOrigin)
            ...
            .query(true)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.getPublisherProfile(PROJECT_ID)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("registerPublisherProfile", () => {
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        nock(api.extensionsOrigin)
            .post(`/${VERSION}/projects/${PROJECT_ID}/publisherProfile:register`)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.registerPublisherProfile(PROJECT_ID, PUBLISHER_ID)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("deprecateExtensionVersion", () => {
    ...
    it("should make a POST call to the correct endpoint", async () => {
        ...
        nock(api.extensionsOrigin)
            .persist()
            .post(`/${VERSION}/publishers/${publisherId}/extensions/${extensionId}/versions/${version}:deprecate`)
            .reply(200, TEST_EXT_VERSION_4);
        const res = await extensionsApi.deprecateExtensionVersion(TEST_EXT_VERSION_4.ref, "This version is deprecated.");
        (0, chai_1.expect)(res).to.deep.equal(TEST_EXT_VERSION_4);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        const { publisherId, extensionId, version } = refs.parse(TEST_EXT_VERSION_4.ref);
        nock(api.extensionsOrigin)
            ...
            .post(`/${VERSION}/publishers/${publisherId}/extensions/${extensionId}/versions/${version}:deprecate`)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.deprecateExtensionVersion(TEST_EXT_VERSION_4.ref, "This version is deprecated.")).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
describe("undeprecateExtensionVersion", () => {
    ...
    it("should make a POST call to the correct endpoint", async () => {
        ...
        nock(api.extensionsOrigin)
            .persist()
            .post(`/${VERSION}/publishers/${publisherId}/extensions/${extensionId}/versions/${version}:undeprecate`)
    ...
    it("should throw a FirebaseError if the endpoint returns an error response", async () => {
        ...
        nock(api.extensionsOrigin)
            ...
            .post(`/${VERSION}/publishers/${publisherId}/extensions/${extensionId}/versions/${version}:undeprecate`)
            .reply(404);
        await (0, chai_1.expect)(extensionsApi.undeprecateExtensionVersion(TEST_EXT_VERSION_3.ref)).to.be.rejectedWith(error_1.FirebaseError);
        (0, chai_1.expect)(nock.isDone()).to.be.true;
    });
});
