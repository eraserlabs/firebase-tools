...
const extensionVersionResponse = (version, spec) => {
    return {
...
describe("provisioningHelper", () => {
    ...
    describe("getUsedProducts", () => {
        ...
        it("returns empty array when nothing is used", () => {
            (0, chai_1.expect)(provisioningHelper.getUsedProducts(testSpec)).to.be.empty;
        });
        it("returns STORAGE when Storage API is used", () => {
            var _a;
            (_a = testSpec.apis) === null || _a === void 0 ? void 0 : _a.push({
                apiName: "storage-component.googleapis.com",
                reason: "whatever",
            });
            (0, chai_1.expect)(provisioningHelper.getUsedProducts(testSpec)).to.be.deep.eq([
                provisioningHelper.DeferredProduct.STORAGE,
            ]);
        });
        it("returns STORAGE when Storage Role is used", () => {
            var _a;
            (_a = testSpec.roles) === null || _a === void 0 ? void 0 : _a.push({
        ...
        it("returns STORAGE when Storage trigger is used", () => {
            var _a;
            (_a = testSpec.resources) === null || _a === void 0 ? void 0 : _a.push({
    ...
    describe("checkProductsProvisioned", () => {
        it("passes provisioning check status when nothing is used", async () => {
            await (0, chai_1.expect)(provisioningHelper.checkProductsProvisioned(PROJECT_ID, {
                resources: [],
            })).to.be.fulfilled;
        });
        it("passes provisioning check when all is provisioned", async () => {
            ...
            await (0, chai_1.expect)(provisioningHelper.checkProductsProvisioned(PROJECT_ID, SPEC_WITH_STORAGE_AND_AUTH)).to.be.fulfilled;
        ...
        it("fails provisioning check storage when default bucket is not linked", async () => {
            ...
            await (0, chai_1.expect)(provisioningHelper.checkProductsProvisioned(PROJECT_ID, SPEC_WITH_STORAGE_AND_AUTH)).to.be.rejectedWith(error_1.FirebaseError, "Firebase Storage: store and retrieve user-generated");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
        ...
        it("fails provisioning check storage when no auth is not provisioned", async () => {
            ...
            nock(api.firebaseStorageOrigin)
                .get(`/v1beta/projects/${PROJECT_ID}/buckets`)
                .reply(200, FIREBASE_STORAGE_DEFAULT_BUCKET_LINKED_RESPONSE);
            await (0, chai_1.expect)(provisioningHelper.checkProductsProvisioned(PROJECT_ID, SPEC_WITH_STORAGE_AND_AUTH)).to.be.rejectedWith(error_1.FirebaseError, "Firebase Authentication: authenticate and manage users from");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
    describe("bulkCheckProductsProvisioned", () => {
        it("passes provisioning check status when nothing is used", async () => {
            ...
            await (0, chai_1.expect)(provisioningHelper.bulkCheckProductsProvisioned(PROJECT_ID, [instanceSpec("0.1.0")])).to.be.fulfilled;
        });
        it("passes provisioning check when all is provisioned", async () => {
            nock(api.extensionsOrigin)
                .get(`/v1beta/publishers/test/extensions/test/versions/0.1.0`)
        ...
        it("checks all products for multiple versions", async () => {
            ...
            nock(api.firebaseStorageOrigin)
                .get(`/v1beta/projects/${PROJECT_ID}/buckets`)
                .reply(200, FIREBASE_STORAGE_DEFAULT_BUCKET_LINKED_RESPONSE);
            await (0, chai_1.expect)(provisioningHelper.bulkCheckProductsProvisioned(PROJECT_ID, [
                instanceSpec("0.1.0"),
                instanceSpec("0.1.1"),
            ])).to.be.fulfilled;
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        ...
        it("fails provisioning check storage when default bucket is not linked", async () => {
            ...
            await (0, chai_1.expect)(provisioningHelper.bulkCheckProductsProvisioned(PROJECT_ID, [instanceSpec("0.1.0")])).to.be.rejectedWith(error_1.FirebaseError, "Firebase Storage: store and retrieve user-generated");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
        it("fails provisioning check storage when no auth is not provisioned", async () => {
            nock(api.extensionsOrigin)
            ...
            nock(api.firedataOrigin).get(`/v1/projects/${PROJECT_ID}/products`).reply(200, {});
            await (0, chai_1.expect)(provisioningHelper.bulkCheckProductsProvisioned(PROJECT_ID, [instanceSpec("0.1.0")])).to.be.rejectedWith(error_1.FirebaseError, "Firebase Authentication: authenticate and manage users from");
            (0, chai_1.expect)(nock.isDone()).to.be.true;
        });
    });
});
//# sourceMappingURL=provisioningHelper.spec.js.map