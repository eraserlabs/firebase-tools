...
describe("optionsHelper", () => {
    describe("getParams", () => {
        ...
        it("should return user and autopopulated params", () => {
            ...
            (0, chai_1.expect)(optionsHelper.getParams(testOptions, testSpec)).to.deep.eq(Object.assign({
                USER_PARAM1: "val1",
                USER_PARAM2: "val2",
            }, autoParams));
        });
    ...
    describe("getNonSecretEnv", () => {
        it("should return only params that are not secret", () => {
            (0, chai_1.expect)(optionsHelper.getNonSecretEnv(TEST_PARAMS, TEST_PARAM_VALUES)).to.deep.equal({
                SELECT_PARAM: "select",
                STRING_PARAM: "string",
                MULTISELECT_PARAM: "multiselect",
            });
    ...
    describe("getSecretEnv", () => {
        it("should return only params that are secret", () => {
            (0, chai_1.expect)(optionsHelper.getSecretEnvVars(TEST_PARAMS, TEST_PARAM_VALUES)).to.have.deep.members([
                {
                    projectId: "test",
                    key: "SECRET_PARAM",
                    secret: "mysecret",
...
//# sourceMappingURL=optionsHelper.spec.js.map