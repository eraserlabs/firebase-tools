...
describe("metricsUtil", () => {
    describe(`${metricsUtils_1.parseBucket.name}`, () => {
        it("should parse a bucket based on the higher bound value", () => {
            (0, chai_1.expect)((0, metricsUtils_1.parseBucket)(10)).to.deep.equals({ low: 0, high: 10 });
            (0, chai_1.expect)((0, metricsUtils_1.parseBucket)(50)).to.deep.equals({ low: 40, high: 50 });
            (0, chai_1.expect)((0, metricsUtils_1.parseBucket)(200)).to.deep.equals({ low: 100, high: 200 });
            (0, chai_1.expect)((0, metricsUtils_1.parseBucket)(2200)).to.deep.equals({ low: 2100, high: 2200 });
            (0, chai_1.expect)((0, metricsUtils_1.parseBucket)(0)).to.deep.equals({ low: 0, high: 0 });
        });
    });
    describe("buildMetricsTableRow", () => {
        it("shows decreasing instance count properly", () => {
            ...
            (0, chai_1.expect)((0, metricsUtils_1.buildMetricsTableRow)(metric)).to.deep.equals([
                "0.0.1",
                "400 - 500",
                clc.green("▲ ") + "100 (±100)",
                clc.green("▲ ") + "300 (±100)",
    ...
    describe(`${metricsUtils_1.parseTimeseriesResponse.name}`, () => {
        it("should parse TimeSeriesResponse into list of BucketedMetrics", () => {
            const series = [
                {
                    ...
                    metricKind: cloudmonitoring_1.MetricKind.GAUGE,
                    resource: {
                        labels: {
                            extension: "export-bigquery",
                            publisher: "firebase",
                    ...
                    valueType: cloudmonitoring_1.ValueType.INT64,
                    points: [
                        {
                            interval: {
            ...
            (0, chai_1.expect)((0, metricsUtils_1.parseTimeseriesResponse)(series)).to.deep.equals([
                {
                    ref: {
...
//# sourceMappingURL=metricsUtils.spec.js.map