...
describe("IndexSpecMatching", () => {
    it("should identify a positive index spec match", () => {
        ...
        (0, chai_1.expect)(idx.indexMatchesSpec(apiIndex, specIndex)).to.eql(true);
    });
    it("should identify a negative index spec match", () => {
        ...
        (0, chai_1.expect)(idx.indexMatchesSpec(apiIndex, specIndex)).to.eql(false);
    });
...
describe("IndexSorting", () => {
    ...
    it("should correctly sort an array of API indexes", () => {
        ...
        (0, chai_1.expect)([b, a, d, c].sort(sort.compareApiIndex)).to.eql([a, b, c, d]);
    });
