    ...
    describe("Interactive flows", () => {
        ...
        describe("getOrPromptProject", () => {
            it("should get project from list if it is able to list all projects", async () => {
                ...
                (0, chai_1.expect)(project).to.deep.equal(TEST_FIREBASE_PROJECT);
                (0, chai_1.expect)(promptOnceStub).to.be.calledOnce;
                (0, chai_1.expect)(promptOnceStub.firstCall.args[0].type).to.equal("list");
            ...
            it("should prompt project id if it is not able to list all projects", async () => {
                ...
                (0, chai_1.expect)(project).to.deep.equal(TEST_FIREBASE_PROJECT);
                (0, chai_1.expect)(promptOnceStub).to.be.calledOnce;
                (0, chai_1.expect)(promptOnceStub.firstCall.args[0].type).to.equal("input");
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
            it("should throw if there's no project", async () => {
                ...
                (0, chai_1.expect)(err.message).to.equal("There are no Firebase projects associated with this account.");
            ...
            it("should throw error when getFirebaseProject throw an error", async () => {
                ...
                (0, chai_1.expect)(err.message).to.equal("Failed to get Firebase project my-project-123" +
                    ". Please make sure the project exists and your account has permission to access it.");
                (0, chai_1.expect)(err.original.toString()).to.contain("Failed to get project");
                (0, chai_1.expect)(promptOnceStub).to.be.not.called;
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
        });
        describe("promptAvailableProjectId", () => {
            it("should select project from list if it is able to list all projects", async () => {
                ...
                (0, chai_1.expect)(projectId).to.deep.equal("my-project-123");
                (0, chai_1.expect)(promptOnceStub).to.be.calledOnce;
                (0, chai_1.expect)(promptOnceStub.firstCall.args[0].type).to.equal("list");
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
            ...
            it("should throw if there's no project", async () => {
                ...
                (0, chai_1.expect)(err.message).to.equal("There are no available Google Cloud projects to add Firebase services.");
                (0, chai_1.expect)(promptOnceStub).to.be.not.called;
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
        });
    ...
    describe("API methods", () => {
        describe("createCloudProject", () => {
            it("should resolve with cloud project data if it succeeds", async () => {
                ...
                (0, chai_1.expect)(resultProjectInfo).to.equal(expectedProjectInfo);
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            ...
            it("should reject if Cloud project creation fails", async () => {
                ...
                (0, chai_1.expect)(err.message).to.equal("Failed to create project. See firebase-debug.log for more info.");
        ...
        describe("addFirebaseToCloudProject", () => {
            it("should resolve with Firebase project data if it succeeds", async () => {
                ...
                (0, chai_1.expect)(resultProjectInfo).to.deep.equal(expectFirebaseProjectInfo);
                (0, chai_1.expect)(nock.isDone()).to.be.true;
                (0, chai_1.expect)(pollOperationStub).to.be.calledOnceWith({
            ...
            it("should reject if add Firebase api call fails", async () => {
                ...
                (0, chai_1.expect)(err.message).to.equal("Failed to add Firebase to Google Cloud Platform project. See firebase-debug.log for more info.");
                (0, chai_1.expect)(err.original).to.be.an.instanceOf(error_1.FirebaseError, "Not Found");
                (0, chai_1.expect)(nock.isDone()).to.be.true;
                (0, chai_1.expect)(pollOperationStub).to.be.not.called;
            });
        ...
        describe("getAvailableCloudProjectPage", () => {
            it("should resolve with a project page if it succeeds (no input token)", async () => {
                ...
                (0, chai_1.expect)(projectPage.projects).to.deep.equal(expectedProjectList);
                (0, chai_1.expect)(projectPage.nextPageToken).to.equal(NEXT_PAGE_TOKEN);
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
            ...
            it("should resolve with a project page if it succeeds with no next page token", async () => {
                ...
                const projectPage = await projectManager.getAvailableCloudProjectPage(pageSize);
                (0, chai_1.expect)(projectPage.projects).to.deep.equal(expectedProjectList);
                (0, chai_1.expect)(projectPage.nextPageToken).to.be.undefined;
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
            it("should reject if the api call fails", async () => {
                ...
                (0, chai_1.expect)(err.message).to.equal("Failed to list available Google Cloud Platform projects. See firebase-debug.log for more info.");
                (0, chai_1.expect)(err.original.toString()).to.contain("Not Found");
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
        });
        describe("getFirebaseProjectPage", () => {
            ...
            it("should reject if the api call fails", async () => {
                ...
                (0, chai_1.expect)(err.message).to.equal("Failed to list Firebase projects. See firebase-debug.log for more info.");
                (0, chai_1.expect)(err.original.toString()).to.contain("Not Found");
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
        });
        describe("listFirebaseProjects", () => {
            it("should resolve with project list if it succeeds with only 1 api call", async () => {
                ...
                (0, chai_1.expect)(projects).to.deep.equal(expectedProjectList);
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
        ...
        describe("getFirebaseProject", () => {
            it("should resolve with project information if it succeeds", async () => {
                ...
                (0, chai_1.expect)(projects).to.deep.equal(expectedProjectInfo);
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
            it("should reject if the api call fails", async () => {
                nock(api.firebaseApiOrigin)
                ...
                (0, chai_1.expect)(err.message).to.equal(`Failed to get Firebase project ${PROJECT_ID}. ` +
                    "Please make sure the project exists and your account has permission to access it.");
                (0, chai_1.expect)(err.original.toString()).to.contain("Not Found");
                (0, chai_1.expect)(nock.isDone()).to.be.true;
            });
