...
describe("cloudRunProxy", () => {
    ...
    it("should error when not provided a valid Cloud Run service ID", async () => {
        const mwGenerator = (0, cloudRunProxy_1.default)(fakeOptions);
    ...
    it("should cache calls to look up Cloud Run service URLs", async () => {
        ...
        (0, chai_1.expect)(spyMw.calledOnce).to.be.true;
        (0, chai_1.expect)(multiNock.isDone()).to.be.true;
        const failMultiNock = nock(api_1.cloudRunApiOrigin)
            .get("/v1/projects/project-foo/locations/us-central1/services/multiLookup")
            .reply(500, "should not happen");
        const mw2Generator = (0, cloudRunProxy_1.default)(fakeOptions);
        ...
        (0, chai_1.expect)(spyMw2.calledOnce).to.be.true;
        (0, chai_1.expect)(failMultiNock.isDone()).to.be.false;
        await supertest(spyMw2).get("/").expect(200, "live version");
        (0, chai_1.expect)(spyMw2.calledTwice).to.be.true;
        (0, chai_1.expect)(failMultiNock.isDone()).to.be.false;
    });
