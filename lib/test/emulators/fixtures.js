...
exports.StorageRulesFiles = exports.IMAGE_FILE_BASE64 = exports.FunctionRuntimeBundles = exports.MODULE_ROOT = exports.createTmpDir = exports.TIMEOUT_MED = exports.TIMEOUT_LONG = void 0;
const fs = require("fs");
...
function createTmpDir(dirName) {
    return fs.mkdtempSync(path.join((0, os_1.tmpdir)(), dirName));
}
exports.createTmpDir = createTmpDir;
exports.MODULE_ROOT = (0, functionsEmulatorShared_1.findModuleRoot)("firebase-tools", __dirname);
